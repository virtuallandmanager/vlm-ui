  ...
  <v-dialog v-model="value" max-width="900">
    <v-card>
      ...
      <v-card-text>
        ...
        <p>
          Virtual Land Manager follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, Virtual Land Manager uses "cookies". These
        ...
        <P
          ...
          advertising partners of Virtual Land Manager.</P
        >

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Virtual Land Manager, which
        ...
        <p>
          Note that Virtual Land Manager has no access to or control over these
        ...
        <p>
          Virtual Land Manager's Privacy Policy does not apply to other
        ...
        <p>
          Virtual Land Manager does not knowingly collect any Personal
        ...
        <p>
          ...
          shared and/or collect in Virtual Land Manager. This policy is not
